...
class FridgeRepository {
  ...
  static Future<void> _seedDefaultItemsIfNeeded() async {
    ...
    final defaults = <FridgeItem>[
      _seedItem(id: '${now}_0', name: 'Соль', amountBase: 300000, unit: IngredientUnit.g, order: 0),
      _seedItem(id: '${now}_1', name: 'Перец', amountBase: 50000, unit: IngredientUnit.g, order: 1),
      _seedItem(id: '${now}_2', name: 'Растительное масло', amountBase: 1000, unit: IngredientUnit.ml, order: 2),
      _seedItem(id: '${now}_3', name: 'Вода', amountBase: 2000, unit: IngredientUnit.ml, order: 3),
      _seedItem(id: '${now}_4', name: 'Лук', amountBase: 5000, unit: IngredientUnit.pcs, order: 4),
      _seedItem(id: '${now}_5', name: 'Чеснок', amountBase: 12000, unit: IngredientUnit.pcs, order: 5),
      _seedItem(id: '${now}_6', name: 'Соевый соус', amountBase: 400, unit: IngredientUnit.ml, order: 6),
      _seedItem(id: '${now}_7', name: 'Мед', amountBase: 250000, unit: IngredientUnit.g, order: 7),
      _seedItem(id: '${now}_8', name: 'Коричневый сахар', amountBase: 500000, unit: IngredientUnit.g, order: 8),
      _seedItem(id: '${now}_9', name: 'Лимонный сок', amountBase: 300, unit: IngredientUnit.ml, order: 9),
      _seedItem(id: '${now}_10', name: 'Кукурузный крахмал', amountBase: 200000, unit: IngredientUnit.g, order: 10),
      _seedItem(id: '${now}_11', name: 'Говядина', amountBase: 1000000, unit: IngredientUnit.g, order: 11),
      _seedItem(id: '${now}_12', name: 'Помидор', amountBase: 4000, unit: IngredientUnit.pcs, order: 12),
      _seedItem(id: '${now}_13', name: 'Салат', amountBase: 200000, unit: IngredientUnit.g, order: 13),
      _seedItem(id: '${now}_14', name: 'Сыр чеддер', amountBase: 300000, unit: IngredientUnit.g, order: 14),
    ];
